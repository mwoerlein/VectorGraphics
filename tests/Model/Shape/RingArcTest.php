...
class RingArcTest extends AbstractShapeTest
{
    ...
    public function getPathProvider()
    {
        ...
        $data['0/8 translated'] = [
            ...
            'points' => [
                'si' => [-1.4823619097949585, 2.9318516525781364],
                'sm' => [-1.0941333421411774, 4.3807403920117389],
                'so' => [-0.7059047744873963, 5.8296291314453415],
                'ci' => [-1.4823619097949585, 2.9318516525781364],
                'cm' => [-1.0941333421411774, 4.3807403920117389],
                'co' => [-0.7059047744873963, 5.8296291314453415],
                'ei' => [-1.4823619097949585, 2.9318516525781364],
                'em' => [-1.0941333421411774, 4.3807403920117389],
                'eo' => [-0.7059047744873963, 5.8296291314453415],
            ],
        ];
        ...
        $data['1/8 translated'] = [
            ...
            'points' => [
                ...
                'sm' => [-1.0941333421411774, 4.3807403920117389],
                'so' => [-0.7059047744873963, 5.8296291314453415],
                'ci' => [-0.78247714198255869, 2.5867066805824703],
                'cm' => [0.13066500153052241, 3.7767366910193232],
                'co' => [1.0438071450436031, 4.9667667014561756],
                'ei' => [-0.26794919243112281, 2],
                'em' => [1.0310889132455352, 2.7500000000000004],
                'eo' => [2.3301270189221928, 3.5000000000000004],
            ],
        ];
        ...
        $data['5/8 translated'] = [
            ...
            'points' => [
                ...
                'sm' => [-1.0941333421411774, 4.3807403920117389],
                'so' => [-0.7059047744873963, 5.8296291314453415],
                'ci' => [-0.41329331941752967, -0.21752285801744131],
                'cm' => [0.77673669101932319, -1.1306650015305224],
                'co' => [1.9667667014561756, -2.0438071450436031],
                'ei' => [-3.7320508075688767, -8.8817841970012523E-16],
                'em' => [-5.0310889132455348, -0.75000000000000155],
                'eo' => [-6.3301270189221919, -1.5000000000000022],
            ],
        ];
        ...
        $data['8/8 translated'] = [
            ...
            'points' => [
                ...
                'sm' => [-1.0941333421411774, 4.3807403920117389],
                'so' => [-0.7059047744873963, 5.8296291314453415],
                'ci' => [-2.5176380902050424, -0.9318516525781364],
                'cm' => [-2.9058666578588213, -2.3807403920117394],
                'co' => [-3.2940952255126059, -3.8296291314453406],
                'ei' => [-1.4823619097949585, 2.9318516525781364],
                'em' => [-1.0941333421411774, 4.3807403920117389],
                'eo' => [-0.7059047744873963, 5.8296291314453415],
            ],
     ...
     * @param array[] $points
     */
    public function testGetPoint($arc, $ignore, array $points)
    {
        $this->assertEquals($points, [
            'si' => $arc->getPoint(RingArc::ALPHA_START, RingArc::RADIUS_INNER),
            'sm' => $arc->getPoint(RingArc::ALPHA_START, RingArc::RADIUS_MIDDLE),
            'so' => $arc->getPoint(RingArc::ALPHA_START, RingArc::RADIUS_OUTER),
            'ci' => $arc->getPoint(RingArc::ALPHA_CENTRAL, RingArc::RADIUS_INNER),
            'cm' => $arc->getPoint(RingArc::ALPHA_CENTRAL, RingArc::RADIUS_MIDDLE),
            'co' => $arc->getPoint(RingArc::ALPHA_CENTRAL, RingArc::RADIUS_OUTER),
            'ei' => $arc->getPoint(RingArc::ALPHA_END, RingArc::RADIUS_INNER),
            'em' => $arc->getPoint(RingArc::ALPHA_END, RingArc::RADIUS_MIDDLE),
            'eo' => $arc->getPoint(RingArc::ALPHA_END, RingArc::RADIUS_OUTER),
        ]);
    }
}
